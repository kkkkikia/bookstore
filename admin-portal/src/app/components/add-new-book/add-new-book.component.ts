...
export class AddNewBookComponent implements OnInit {
  ...
  private categories:string[]=['Management','Fiction','Engineering','Programming','ArtsAndLiterature'];
  private formats:string[]=['Paperback','HardCover'];
  private languages:string[]=['English','Spanish'];
